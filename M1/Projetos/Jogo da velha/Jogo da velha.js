...
console.log()
const jog1 = 
  prompt('Qual o nome do 1º jogador ?').toUpperCase().trim()
    console.clear()
const jog2 = 
  prompt('Qual o nome do 2º jogador?').toUpperCase().trim()
    console.clear()

const item2 = correcao(prompt(`${jog1} quer jogar com 'X' ou 'O'? `).toUpperCase().trim())
...
inicio : for(let rod = 0; rod < 9;){
 ...
 C [  ?  ]`)
  ...
  console.log()
    ...
    if( linha == 'a'){var li = 0 
                     linh.push(li)
                     break;}
    else if(linha == 'b'){var li =1
                         linh.push(li)
                         break;}
    else if(linha == 'c'){var li = 2
                         linh.push(li)
                         break;}
    else{
 ...
 //______________________if's__________________________________\\ 
   if(rod >= 0 ){comando(li,coluna,0,item2)}
   if(rod >= 1 ){ if (comando(li,coluna,1,item1) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio}}
   if(rod >= 2 ){ if (comando(li,coluna,2,item2) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio }}
   if(rod >= 3 ){ if (comando(li,coluna,3,item1) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio }}
   if(rod >= 4 ){ if (comando(li,coluna,4,item2) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio }}
   if(rod >= 5 ){ if (comando(li,coluna,5,item1) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio }}
   if(rod >= 6 ){ if (comando(li,coluna,6,item2) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio }}
   if(rod >= 7 ){ if (comando(li,coluna,7,item1) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio }}
   if(rod >= 8 ){ if (comando(li,coluna,8,item2) == 0){
     colun.pop();
     linh.pop();
     console.log('Posiçao ja escolhida,tente novamente')
                      continue inicio }}
  ...
  if(arraylinhas[0][0] == iten && arraylinhas[0][1] == iten &&  arraylinhas[0][2] == iten ||
     arraylinhas[1][0] == iten && arraylinhas[1][1] == iten &&  arraylinhas[1][2] == iten ||
     arraylinhas[2][0] == iten && arraylinhas[2][1] == iten &&  arraylinhas[2][2] == iten ||
     arraylinhas[0][0] == iten && arraylinhas[1][0] == iten &&  arraylinhas[2][0] == iten ||
     arraylinhas[0][1] == iten && arraylinhas[1][1] == iten &&  arraylinhas[2][1] == iten ||
     arraylinhas[0][2] == iten && arraylinhas[1][2] == iten &&  arraylinhas[2][2] == iten ||
     arraylinhas[0][0] == iten && arraylinhas[1][1] == iten &&  arraylinhas[2][2] == iten ||
     arraylinhas[0][2] == iten && arraylinhas[1][1] == iten &&  arraylinhas[2][0] == iten ){
    
    console.log(`${jog} voce ganhou essa rodada`)
    console.log()
    let repetir = prompt('Querem jogar mais uma partida?').toLowerCase().trim()

    if(jog == jog1){vitoriajogador1++
                   }else if(jog == jog2){vitoriajogador2++}
    
     if(repetir == 'sim'){
        for(let res = 0; res < rod;){rod--}
        colun.splice(0)
        linh.splice(0)
        continue inicio
      }else{break;}
...
if(vitoriajogador1 > vitoriajogador2){
  console.log()
  console.log(`${jog1} voce foi o grande campeao, ganhando ${vitoriajogador1} rodadas `)
  console.log()
  console.log('Bye Bye \\o// ')
}else if(vitoriajogador2 > vitoriajogador1){
  console.log()
  console.log(`${jog2} voce foi o grande campeao, ganhando ${vitoriajogador2} rodadas `)
  console.log()
  console.log('Bye Bye \\o// ')}
