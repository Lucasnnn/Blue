...
inici: while (true) {
  ...
  if (qua / qua == 1) {
    ...
    for (let i = 0; qua > i; i++) {
      ...
      if (entr == "PEDRA" || entr == "PAPEL" || entr == "TESOURA") {
        ...
        if (entr == ppt[mix]) {
          ...
          (entr == "PEDRA" && ppt[mix] == "TESOURA") ||
          (entr == "TESOURA" && ppt[mix] == "PAPEL") ||
          (entr == "PAPEL" && ppt[mix] == "PEDRA")
        ) {
          console.log(entr + " VS " + ppt[mix] + " . dessa vez você ganhou");
          hum++;
        } else {
          console.log(entr + " VS " + ppt[mix] + " . dessa vez eu ganhei");
          pc++;
        }
      } else {
    ...
    if (pc > hum) {
      console.log();
      console.log(
        "I.A ganhou " + pc + " rodada e você ganhou " + hum + " rodada"
      );
      console.log();
      ...
      console.log();
      console.log(
        "Você ganhou " + hum + " rodada e a I.A ganhou " + pc + " rodada"
      );
      console.log();
